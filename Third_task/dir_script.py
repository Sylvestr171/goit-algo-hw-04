...
if len(sys.argv) == 2 and path_validation(sys.argv[1]):
    print ('MAIN FOO')
elif len(sys.argv) == 2 and sys.argv[1] in ('-h', '--help', '/?'):
    show_detailed_help()
elif len(sys.argv) == 2 and not(path_validation(sys.argv[1])):
    print ('Даний шлях не існує або аргумент не є шляхом')
    show_short_help()
else:
    show_short_help()
